"""
EAA CONTROL - SUPERVISOR (IMMORTAL VERSION)
===========================================
...
MAIN_SERVER = os.path.join(SCRIPT_DIR, "eaa_control_email.py")
...
def send_crash_notification(reason="Server Crashed"):
    ...
    body = f"""
{'='*50}
   EAA CONTROL - SUPERVISOR NOTIFICATION
{'='*50}
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("  EAA CONTROL - SUPERVISOR (IMMORTAL)")

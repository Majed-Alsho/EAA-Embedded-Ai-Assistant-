...
# ==========================================
#   CONFIGURATION (SHADOW BRAIN EDITION)
# ==========================================
MODEL_ID   = "unsloth/Qwen2.5-7B-Instruct-bnb-4bit"

# 1. NEW DATASET (The Chaos Data)
DATA_FILE  = "train_data/shadow_personality.jsonl" 

# 2. NEW SAVE LOCATION (Protects the Master Brain)
OUTPUT_DIR = "lora/shadow_brain" 

MAX_SEQ_LENGTH = 2048
MAX_STEPS      = 500  # 500 steps is good for 5k lines
...
def train():
    ...
    print("==================================================")
    print("💀 INITIALIZING SHADOW PROTOCOL TRAINING")
    print("==================================================")
    ...
    args = TrainingArguments(
        output_dir="outputs/shadow_temp", # Temp folder for checkpoints
        max_steps=MAX_STEPS,
    ...
    print("\n✅ Training Complete!")
    print(f"💾 Saving SHADOW LoRA Adapter to: {OUTPUT_DIR}")
    model.save_pretrained(OUTPUT_DIR)
    tokenizer.save_pretrained(OUTPUT_DIR)

    print("DONE. You now have TWO brains.")
